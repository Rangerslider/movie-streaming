    ...
    ?>
     ...
     <section>
          <div class="jumbotrons">
            <h2 style='margin-top:0px;padding-top:0px;'>Others Movies</h2>
              <div class="row">
              <?php
                include 'database.php';


                  $im = "SELECT * FROM movies WHERE genre='tiktok' OR genre='fiction' OR genre='horror' OR genre='music' OR genre='other'" ;
